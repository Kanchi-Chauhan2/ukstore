...
<head>
    ...
    <title>What BC Can Do For You</title>
...
<div class="header__menu" style="position:relative;">
    ...
    <div class="Blog-container">
        <div class="heading__all">
            <h1>What BC Can Do For You</h1>
        </div>
        <div class="Blog-body">
                <a href="#" class="blog__imagebox">
                    <img src="" alt="" class="blog__post--imagee" >
                </a>
                <div class="Blog-content">
                    <p class="blog-para">
                    <h3 class="heading__para">SKIN SCIENCE TECHNOLOGY</h3>
                    <h3 class="heading__para">“HEALING THE WOUNDS OF TIME”</h3>
                    <h3 class="heading__para">Lighten with confidence: beautify the skin you're in</h3>
<p class="breakk">Beauty today begins with skin that glows with optimum health, glow with opulence and formulated to
a colour depth that’s just right for you.</p>

<p class="breakk">Don’t you think that could be your smooth and polished face? It sure can…

Afraid to show your shoulders (or maybe a little bit more)? Let us show you how.</p>

<p class="breakk">Today’s advanced skin science technology merges with beauty to create more options for you than ever

before—what colour is your shade? And whether you want natural lightening like Halle Berry or a

Beyonce, or just be beautiful and brown like Naomi Campbell, its all about skin health.</p>
<p class="breakk"> Body contours

understands your skin, we treat all skin types, especially people of colour.</p>

<p class="breakk">And now, what colour depth and glow you’ll choose for your skin—a skin that’s free of freckles,

wrinkles, scarring, roughness, dark spot discolouration, or other detractions that make your skin

anything less than smooth and polish</p>

<h3 class="heading__para">Lighten with confidence</h3>
<p class="breakk">Whatever decision you make your skin colour, you want your choices to be healthy, safe, and most of

all, to create a more polished you and that’s what BODY CONTOURS products are all about.</p>

<p class="breakk">Buy BODYCONTOURS with confidence that our products will first and foremost make your skin

smooth and supple, lovable (touchable), and that your colour level will be a supremely even tone at the

depth you desire. With over 25 years of tireless research backs our claim.</p>

<p class="breakk">Use BODYCONTOURS with confidence that the utmost care has been taken to ensure the safety of

our products and that your skin will attain its healthiest and most even glow when our products are

used according to our instructions.</p>

<p class="breakk">None of our products contains hydroquinone, mercury, or other dangerous or banned elements.

BODYCONTOURS has never used these ingredients (and we never will). BODYCONTOURS

chooses only sumptuous hydrants, the rarest creams and gels, exotic preparations, natural fruit extracts

and natural whitening ingredients. These ingredients have been proven to be safe and effective in

lightening and brightening skin discolouration, pigmentation problems, and age spots.</p>

<p class="breakk">Talk to BODYCONTOURS with confidence that our staff is chosen with special care, trained in our

product lines, and dedicated to bringing you exceptional service and quality. As the industry leader in

skin lightening care & dark spot colour correction, we employ only the best staff and the mostz

reputable skin care & product specialists who deliver the finest skin lightening product lines available

for peoples of colour today.</p>

<h3 class="heading__para">Why BC ?</h3>
<p class="breakk">BodycontoursUK has been the market leader and discerning consumer choice in anti-aging skin

lightening, skin brightening and skin whitening products since 1994. We have touched and transformed

many of skin tones and types all across the globe.</p>

<p class="breakk">Why because delivers nothing but results. In more than 20 years of delivering BODYCONTOURS UK

skin to our clients, BC has had more than 99% satisfaction ratings* (so who else are you going to

choose to smooch your Skin ?)</p>

<h3 class="heading__para">SKIN LIGHTENING PRODUCTS</h3>
<h3 class="heading__para">Skin LIGHTENING and Skin Bleaching Cream</h3>
<p class="breakk">Imagine…more sensual skin in as little as few days with exquisite skin lightening and skin bleaching

creams from BODYCONTOURS UK

Welcome to BODYCONTOURS. Our unique, dermatologist-approved skin lightening and bleaching

products have been beautifully transforming head to toe complexions for over two decades. These

creamy, dreamy, natural formulations are simply among the safest, healthiest – and most effective –

ways to lighten , soften and protect skin.</p>

<h3 class="heading__para">What BodycontoursUK Skin lightening and</h3>
<h3 class="heading__para">Bleaching Products Can Do For You</h3>
<p class="breakk">One smooth slather of our skin lightening and bleaching products and you'll notice the difference…the

luxurious texture, the rich feel, the soft scents. Keep applying our products and in as little as a few days

you'll start to experience a smoother, brighter, lighter, more even complexion.</p>

<p class="breakk">At BodycontoursUK, we take a holistic approach to our formulations. That is why our skin lightening

and skin bleaching products do not contain the damaging and toxic chemicals hydroquinone and

mercury. All of our products are botanically based and as a result are safe, natural and gentle.</p>

<h3 class="heading__para">Our Skin lightening and Skin Bleaching Products are</h3>
<h3 class="heading__para">amazing! “Feel the difference… see the difference!…”</h3>
<p class="breakk">To find out more information about our treatments, please book a Consultation or call Bridget on

Mobile: 0795-707-7011 and also on Landline:0208-857-8559</p>
